...
import net.javaspring.ems.exception.AuthApiException;
...
//    private ModelMapper modelMapper;
    ...
    public String register(RegisterDto registerDto) {
        ...
        if (userRepository.existsByUsername(registerDto.getUsername())){
            throw new AuthApiException(HttpStatus.BAD_REQUEST, "Username is already existed!");
        }

        if(userRepository.existsByEmail(registerDto.getEmail())){
            throw new AuthApiException(HttpStatus.BAD_REQUEST, "Email is already existed!");
        }
